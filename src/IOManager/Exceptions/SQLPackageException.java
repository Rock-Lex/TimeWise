...
public class SQLPackageException extends Exception {
    /**
     * Erzeugt eine neue SQLPackageException mit der angegebenen Detailnachricht und Ursache.
     *
    ...
    /**
     * Erzeugt eine neue SQLPackageException mit der angegebenen Detailnachricht.
     *
     * @param message Die Detailnachricht (wird später durch Throwable.getMessage() abgerufen).
     */
    ...
    /**
     * Erzeugt eine neue SQLPackageException mit der angegebenen Ursache.
     *
     * @param cause Die Ursache (wird später durch Throwable.getCause() abgerufen). Ein null-Wert ist zulässig und zeigt an, dass die Ursache nicht vorhanden ist oder unbekannt ist.
     */
